          ...
          >
            <div
              ...
              className={
                itemProps.isDragging
                  ? twMerge(
                      clsx(["relative h-[45px] border border-dashed rounded-md bg-gray-800/10"])
                    )
                  : twMerge(
                      clsx([
              ...
              {!itemProps.isDragging && (
                <>
                  <div className="flex items-center justify-center">
                    <button {...itemProps.handleProps} className="cursor-grab p-2">
                      <svg viewBox="0 0 20 20" width="12">
                        <path d="M7 2a2 2 0 1 0 .001 4.001A2 2 0 0 0 7 2zm0 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 7 8zm0 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 7 14zm6-8a2 2 0 1 0-.001-4.001A2 2 0 0 0 13 6zm0 2a2 2 0 1 0 .001 4.001A2 2 0 0 0 13 8zm0 6a2 2 0 1 0 .001 4.001A2 2 0 0 0 13 14z"></path>
                      </svg>
                    </button>
                  ...
                  <div className="flex-grow-1">{itemProps.node.data?.label}</div>
                  {itemProps.isRemovable && (
                    <div>
                      <button
          ...
          >
            <div
              ...
              className={
                itemProps.isDragging
                  ? twMerge(
                      clsx(["relative h-[55px] border border-dashed rounded-md bg-gray-800/10"])
                    )
                  : twMerge(
                      clsx([
